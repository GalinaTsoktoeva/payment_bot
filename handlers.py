...
async def start_handler(msg: Message):
    ...
    await msg.answer(
        text='<b>Рекомендации на апрель по китайскому календарю (до 05.05.2024)</b>\n\n' +

             'Описание энергий апрель: как стоит себя вести, чтобы апрель прошел благоприятно. Также советы для каждого элемента личности - что принесет апрель именно вам 🌟!',
