...
big_button_3 = InlineKeyboardButton(
    text='Оплата',
    callback_data='https://payform.ru/f13E1UQ/',
    url='https://payform.ru/f13E1UQ/'
)
...
async def start_handler(msg: Message):
    ...
    await msg.answer(
        text='<b>Рекомендации на март по китайскому календарю</b>\n\n' +

             'Описание энергий марта: как стоит себя вести, чтобы февраль прошел благоприятно. Также советы для каждого элемента личности - что принесет март именно вам 🌟!',
